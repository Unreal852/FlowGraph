...
namespace FlowGraph.Helpers
{
    public static class RenderHelper
    {
        ...
        {
            return new PointF[] { new PointF(x - (connectorSize + 1.0f) - extra_thickness, y + (connectorSize / 1.5f) + extra_thickness), new PointF(x + 1.0f + extra_thickness, y), new PointF(x - (connectorSize + 1.0f) - extra_thickness, y - (connectorSize / 1.5f) - extra_thickness) };
        }
